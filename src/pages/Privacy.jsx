    ...
    return (
        <div className="container section">
            ...
            <div className="content-block slide-up delay-100">
                ...
                <p>
                    This Privacy Policy governs your access to and use of Workplace Therapeutics, including any content, functionality and services offered on or through Workplace Therapeutics, (the “Website”), whether as a guest or as a registered user. This policy applies to Personal Information we collect on the Website and in email, text, forms or other electronic messages between you and the Website.
                </p>
                <p>
                ...
                <p>
                    Personal Information under PIPEDA or other applicable privacy legislation is any information about an identifiable individual, but does not include the name, title, business address or telephone number of an employee of an organization.
                </p>

                <h3>Why do we collect Personal Information?</h3>
                <p>
                    We collect Personal Information in order to provide massage therapy to you. In addition, we distribute publications and offer educational opportunities concerning the massage therapy industry, which we provide as a service to you and others in our community.
                </p>
                <p>
                ...
                <p>
                    <strong>Information You Provide To Us.</strong> The Website provides various places for users to provide information. We collect information that users provide by filling out forms on the Website, communicating with us via contact forms, responding to surveys, search queries on our search feature, providing comments or other feedback, and providing information when ordering a product or service via the Website.
                </p>
                <p>
                    We use information you provide to us to deliver the requested product and/or service, to improve our overall performance, and to provide you with offers, promotions, and information.
                </p>
                <p>
                    <strong>Information We Collect Through Automatic Tracking Technology.</strong> As you navigate through our Website, we may use automatic data collection technologies including Google Analytics to collect certain information about your equipment, browsing actions, and patterns. This will generally include information about your location, your traffic pattern through our Website, and any communications between your computer and our Website. Among other things, we will collect data about the type of computer you use, your Internet connection, your IP address, your operating system, and your browser type.
                </p>
                <p>
                    The information we collect automatically is used for statistical data and will not include personal information. We use this data to improve our Website and our service offerings. To the extent that you voluntarily provide personal information to us, our systems will associate the automatically collected information with your personal information.
                </p>

                <h3>Use of Cookies And Pixels</h3>
                <p>
                ...
                <ul>
                    ...
                    <li>Other third parties who represent that they have the right to disclose the information.</li>
                </ul>
                ...
                <h3>Updating Information and Correcting Errors</h3>
                <p>
                ...
                <h3>Questions, concerns or requests for access</h3>
                <p>
                ...
                <p>
                    ...
                    Halifax, NS<br />
                    <a href={`tel:${CONTACT_PHONE}`}>{CONTACT_PHONE}</a><br />
